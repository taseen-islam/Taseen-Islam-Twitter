...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "pJUlOwkPBJJ2DAvsKFJdohTne", consumerSecret: "cuwQ5o39lDcclFH3sqd75wKgI28thCdW2llvIviViSV3H5VdPy")
    var loginSuccess: (() -> ())?
